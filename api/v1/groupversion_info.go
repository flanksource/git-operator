...
// Package v1 contains API Schema definitions for the git.flanksource.com v1 API group
// +kubebuilder:object:generate=true
// +groupName=git.flanksource.com
package v1
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "git.flanksource.com", Version: "v1"}
